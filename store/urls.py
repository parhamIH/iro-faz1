...
from .views import (
    ...
    SpecificationViewSet, ProductSpecificationViewSet, WarrantyViewSet , TagViewSet,SpecificationGroupViewSet
)
...
router.register(r'specification-groups', SpecificationGroupViewSet)
